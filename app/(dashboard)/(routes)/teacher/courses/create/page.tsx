...
import { Sparkles, ArrowRight, X, BookOpen, FileText, Loader2 } from 'lucide-react'
  ...
  return (
    <div className='max-w-5xl mx-auto my-auto h-[50vh] p-8 md:p-16'>
      <div className='mb-6 '>
        ...
        <h1 className='text-lg md:text-2xl font-medium text-gray-700 mb-8'>Give your course a title</h1>
        <p className='text-gray-600 text-sm md:text-base'>What would you like to name your course. You can change or edit this course title later</p>
      </div>
      <Form {...form}>
        <form
